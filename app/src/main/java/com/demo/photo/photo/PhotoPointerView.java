 ...
 */
public class PhotoPointerView extends View implements ViewPager.OnPageChangeListener {

    public PhotoPointerView(Context context) {
        this(context, null);
    }

    public PhotoPointerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PhotoPointerView(Context context, AttributeSet attrs, int defStyleAttr) {
