...
class PhotoPointViewBackUp extends View implements ViewPager.OnPageChangeListener {
    ...
    public PhotoPointViewBackUp(Context context) {
        this(context, null);
    }

    public PhotoPointViewBackUp(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PhotoPointViewBackUp(Context context, AttributeSet attrs, int defStyleAttr) {
