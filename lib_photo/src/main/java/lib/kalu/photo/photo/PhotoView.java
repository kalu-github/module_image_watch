...
/**
 * description: 缩放, 平移
 * create by kalu on 2018/10/8 9:09
 */
public class PhotoView extends AppCompatImageView {
    ...
    public boolean canScrollHorizontally(int direction) {
        if (mPinchMode == PhotoView.PINCH_MODE_SCALE) {
            return true;
        }
    ...
    public interface OuterMatrixChangedListener {
         ...
         */
        void onOuterMatrixChanged(PhotoView photoView);
    }
     ...
     * 在onTouchEvent末尾被执行.
     */
    private GestureDetector mGestureDetector = new GestureDetector(PhotoView.this.getContext(), new GestureDetector.SimpleOnGestureListener() {
