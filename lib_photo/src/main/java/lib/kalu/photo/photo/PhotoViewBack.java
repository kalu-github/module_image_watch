 ...
 */
final class PhotoViewBack extends AppCompatImageView {
    ...
    public PhotoViewBack(Context context) {
        super(context);
        setScaleType(ScaleType.MATRIX);
    }

    public PhotoViewBack(Context context, AttributeSet attrs) {
        super(context, attrs);
        setScaleType(ScaleType.MATRIX);
    }

    public PhotoViewBack(Context context, AttributeSet attrs, int defStyleAttr) {
